...
CMapPtrToPtr CCoolControlsManager::m_ctrlMap((INT_PTR)10);
CMapPtrToPtr CCoolControlsManager::m_dlgMap((INT_PTR)10);
BOOL CCoolControlsManager::m_bEnabled = TRUE;

// Changed 02.03.1999 Mike Walter
CMapWordToPtr CCoolControlsManager::m_threadMap((INT_PTR)10);
